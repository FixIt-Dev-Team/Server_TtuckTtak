...
public class UserDataDto {
    ...
    @Builder
    public UserDataDto(String userName, String email, String birthday, String profileImgUrl, AccountType accountType,boolean pushStatus, boolean nightPushStatus){
